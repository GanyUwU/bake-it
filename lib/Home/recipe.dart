...
class Recipe {
  ...
  static Recipe sampleMacarons() {
    return Recipe(
      ...
      calories: '512 cal',
      description:
          'Chocolate is the best kind of dessert! These choco macarons are simply heavenly! Delicate little cookies filled with chocolate ganache. Perfect for afternoon tea or special occasions.',
      ingredients: [
        Ingredient(
            name: 'Granulated sugar',
            amount: '160 g',
            iconColor: Colors.amber[200] ?? Colors.amber),
        Ingredient(
            name: 'Ground almond',
            amount: '160 g',
            iconColor: Colors.amber[400] ?? Colors.amber),
        Ingredient(
            name: 'Dark chocolate',
            amount: '110 g',
            iconColor: Colors.brown[400] ?? Colors.brown),
        Ingredient(
            name: 'Egg whites',
            amount: '4',
            iconColor: Colors.grey[300] ?? Colors.grey),
        Ingredient(
            name: 'Heavy cream', amount: '120 ml', iconColor: Colors.white),
        Ingredient(
            name: 'Cocoa powder',
            amount: '20 g',
            iconColor: Colors.brown[800] ?? Colors.brown),
      ],
    );
  }
}
